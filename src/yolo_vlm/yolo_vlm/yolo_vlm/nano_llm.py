...
class NanoLLMNode(Node):
    def __init__(self):
        ...
        # Parameters (can be provided via a launch file or parameter file)
        ...
        # Subscribe to the "input_image" topic to receive images
        ...
        # Load the VLM model and initialize the chat history
    ...
    def image_callback(self, msg: Image): 
        ...
        # Append the image and text prompt to the chat history and perform inference
